# A sing-along for Bayesian Data Analysis by Gelman et al.
...
The files in here are compiled from R notebooks to .md using knitr. The original R notebooks will be uploaded to a separate repository.
